...
function filter_the_content_in_the_main_loop( $content ) {
    ...
    if (( is_single() OR is_page()) && in_the_loop() && is_main_query() ) {
        ...
        $abgesagte_events ='<div class="ackids_container"><div class="abgesagt"><strong>Bitte beachten:</strong> Aufgrund der aktuellen Problematik (Corona) kann man davon ausgehen, dass so gut wie keine Veranstaltungen stattfinden. Bleibt gesund!</div></div>';
