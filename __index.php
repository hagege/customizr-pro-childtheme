    ...
    <div id="main-wrapper" class="section">
          ...
          <div class="<?php czr_fn_main_container_class() ?>" role="main">
            ...
            <div class="<?php czr_fn_column_content_wrapper_class() ?>">
                ...
                <!-- START: Damit der Container mit der Nummerierung nach den Beiträgen gezeigt wird -->
                ...
                <?php endif ?>
                <!-- ENDE: Damit der Container mit der Nummerierung nach den Beiträgen gezeigt wird -->
